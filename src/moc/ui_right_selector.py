...
class Ui_Right_Selector(object):
    def setupUi(self, Right_Selector):
        ...
        self.Down_toolButton = QtWidgets.QToolButton(Right_Selector)
        ...
        self.Up_toolButton = QtWidgets.QToolButton(Right_Selector)
        ...
        self.listWidget = QtWidgets.QListWidget(Right_Selector)
        ...
        self.Minus_toolButton = QtWidgets.QToolButton(Right_Selector)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/minus-xxl.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Plus_toolButton = QtWidgets.QToolButton(Right_Selector)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("icons/plus-xxl.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Plus_toolButton.setIcon(icon1)
        self.Plus_toolButton.setIconSize(QtCore.QSize(10, 10))
        self.Plus_toolButton.setPopupMode(QtWidgets.QToolButton.InstantPopup)
        self.Plus_toolButton.setArrowType(QtCore.Qt.NoArrow)
